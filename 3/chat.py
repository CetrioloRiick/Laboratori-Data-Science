...
pipelines = [
    ...
    ("Ridge linear regression", Pipeline([("scaler", StandardScaler()), ("model", Ridge(alpha=1.0))])),
    ("Lasso linear regression", Pipeline([("scaler", StandardScaler()), ("model", Lasso(alpha=0.05))])),
]
